const Lead = data => {
    return `
        ...
        <span style="font-weight: bold;">Type of Property: </span>Type of Property: ${data.type} <br />
        <span style="font-weight: bold;">Type of Property: </span>Condition of Property: ${data.condition} <br />
